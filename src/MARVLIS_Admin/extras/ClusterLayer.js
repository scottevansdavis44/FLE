    ...
    return declare([GraphicsLayer], {
        ...
        onClick: function (e) {
            ...
            if (singles.length > this._maxSingles) {
                myInfo("Sorry, this cluster contains more than " + this._maxSingles + " points. Zoom in for more detail.");
                return;
            } else {
                // stop the click from bubbling to the map
                //e.stopPropagation();
                this._map.infoWindow.visibleWhenEmpty = true;
        ...
        _showCluster: function (c) {
            try {
                ...
                var font = new Font("11pt", Font.STYLE_NORMAL, Font.VARIANT_NORMAL, Font.WEIGHT_NORMAL, '"Myriad Pro", "Trebuchet MS", Myriad, "Liberation Sans", "Nimbus Sans L", "Helvetica Neue", Helvetica, Arial, sans-serif');
